...
class WebSocketSecureServer extends Command
{
    ...
    public function handle()
    {
        ...
        $webSock = new SecureServer(
            ...
            $loop,
            array(
                'local_cert'        => '/etc/letsencrypt/live/pumpandgo.net/fullchain.pem', // path to your cert
                'local_pk'          => '/etc/letsencrypt/live/pumpandgo.net/privkey.pem', // path to your server private key
